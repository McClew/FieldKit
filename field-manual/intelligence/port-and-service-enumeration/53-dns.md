...
Subdomains can be enumerated for a target domain using tools like [subfinder.md](../../tooling/subfinder.md "mention"). This tool can scrape subdomains from open sources like [dnsdumpster.md](../../tooling/dnsdumpster.md "mention").
...
Other tools like [sublist3r.md](../../tooling/sublist3r.md "mention") can also be used to brute-force subdomains by supplying a wordlist.&#x20;

An excellent alternative is a tool called [subbrute.md](../../tooling/subbrute.md "mention"). This tool allows us to use self-defined resolvers and perform pure DNS brute-forcing attacks during internal penetration tests on hosts that do not have Internet access.
...
Tools like [fierce.md](../../tooling/fierce.md "mention") can also be used to enumerate all DNS servers of the root domain and scan for a DNS zone transfer:
